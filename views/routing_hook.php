...
<div id="paging" class="element-container">
	...
	<div class="row">
		<div class="col-md-12">
			<span id="paging_notification-help" class="help-block fpbx-help-block"><?php echo _('Will cause the selected Page Group to paged and connected to any call that is served by this route. It is recommended not to use a Page Group that uses (Force) Valet Paging')?></span>
		</div>
	</div>
</div>
<!--END Notifications-->
